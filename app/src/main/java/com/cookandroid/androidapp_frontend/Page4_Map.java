...
public class Page4_Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page4_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in SeoulCityHall and move the camera
